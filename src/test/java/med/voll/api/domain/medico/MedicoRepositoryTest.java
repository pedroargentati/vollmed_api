...
class MedicoControllerTest {
	...
	@Autowired
	private JacksonTester<DadosDetalhamentoMedio> dadosDetalhamentoMedicoJacksonTester;
	...
	void cadastraMedicoCenario1() throws Exception {
		var dadosCadastroMedico = new DadosCadastroMedico("Pedro", "pedro@gmail.com", "90909090", "123456", Especialidade.CARDIOLOGIA, Endereco());
		...
		var dadosDetalhamento = new DadosDetalhamentoMedio(null, dadosCadastroMedico.nome(),
				dadosCadastroMedico.email(), dadosCadastroMedico.crm(), dadosCadastroMedico.telefone(),
				dadosCadastroMedico.especialidade(), new Endereco(dadosCadastroMedico.endereco()));
	...
	private DadosEndereco Endereco() {
		return new DadosEndereco("a", "b", "12345678", "Brasilia", "df", "", "");
	}
}